                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input class="layui-input" name="readerNumber" id="readerNumber" autocomplete="off" placeholder="请输入读者卡号">
                        </div>
                    </div>
                    <div class="layui-inline">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input class="layui-input" name="tel" id="tel" autocomplete="off" placeholder="请输入电话号码">
                        </div>
                    </div>
                    <div class="layui-inline">
    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {templet:"<div>{{layui.util.toDateString(d.registerDate,'yyyy-MM-dd HH:mm:ss')}}</div>", width: 180, title: '办卡时间'},
                {templet: '<div>{{d.email}}</div>', width: 180, title: '邮箱'},
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'update') {
                ...
                layer.confirm('确定要删除这位读者吗？', function (index) {
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'add') {
                ...
                if (data.length === 0) {
                    layer.msg("请至少选择一位读者进行删除");
                } else {
                    var ids = data.map(function(item){ return item.id; }).join(",");
                    layer.confirm('确定要删除选中的 ' + data.length + ' 位读者吗？', function (index) {
        ...
        function deleteInfoByIds(ids, index){
            $.post("deleteReader", {ids: ids}, function (result) {
                if (result.code == 0) {
