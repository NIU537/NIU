                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input class="layui-input" name="name" id="name" autocomplete="off" placeholder="请输入类型名称">
                        </div>
                    </div>
                    <div class="layui-inline">
    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'name', width: 250, title: '类型名称'},
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                layer.confirm('确定要删除此类型吗？', function (index) {
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'add') {
                ...
                if (data.length === 0) {
                    layer.msg("请至少选择一个类型进行删除");
                } else {
                    var ids = data.map(function(item){ return item.id; }).join(",");
                    layer.confirm('确定要删除选中的 ' + data.length + ' 个类型吗？', function (index) {
        ...
        function deleteInfoByIds(ids, index) {
            $.post("deleteType", {ids: ids}, function (result) {
                if (result.code == 0) {
